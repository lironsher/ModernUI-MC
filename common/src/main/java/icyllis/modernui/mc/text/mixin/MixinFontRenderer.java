...
public abstract class MixinFontRenderer {
    ...
    // 1.21.11: text rendering routes through Font#prepareText (hooked by
    // MixinGuiTextRenderState) + ModernPreparedText, so we no longer @Overwrite
    // the drawInBatch / drawInBatch8xOutline methods here (matches feat/mc-26.2).
