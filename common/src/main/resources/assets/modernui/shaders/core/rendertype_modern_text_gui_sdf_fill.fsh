...
// MC 1.21.11 GUI variant of rendertype_modern_text_sdf_fill: dedicated fog-free FS.
// See rendertype_modern_text_gui_normal.fsh for why a separate file is needed in 1.21.11.
